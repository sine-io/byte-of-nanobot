...
> 目标：把你的 Bot 连接到 Telegram、Discord 等平台，让它在真实聊天场景中工作。理解消息总线架构。

## 4.1 从 CLI 到 Gateway

前三章我们一直用 `nanobot agent` 在终端里聊天。现在要让 Bot 活在真正的聊天平台上。
...
[← 上一章：教 Bot 新技能](03-skills.md) | [回到目录](README.md) | [Part2](build/README.md)

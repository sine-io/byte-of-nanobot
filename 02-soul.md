...
| 你想表达的内容 | 应该写到哪里 | 为什么 |
|------|------|------|
| Bot 的气质、语气、价值观 | `SOUL.md` | 这是“像谁”的问题 |
| 回答步骤、工作流、禁止事项 | `AGENTS.md` | 这是“怎么做事”的问题 |
| 用户是谁、偏好什么、长期背景是什么 | `USER.md` | 这是“Bot 如何理解你”的问题 |
| 工具使用偏好、软约束、注意事项 | `TOOLS.md` | 这是“怎么使用工具更合适”的问题 |
| 需要长期记住的事实 | `memory/MEMORY.md` | 这是动态记忆，不是静态人格 |
...
- “禁止访问系统目录”这类硬权限：不要只指望 `TOOLS.md`，真正的限制还要靠配置和工具层
- 临时一次性的任务要求：直接放在当前提问里，不要污染长期的人格和规则文件

一个简单判断法：

- 这是 Bot **长期都该像这样** → 优先写 `SOUL.md`
- 这是 Bot **长期都该按这个流程做事** → 优先写 `AGENTS.md`
- 这是 Bot **关于你应该记住的背景** → 优先写 `USER.md`
- 这是 Bot **调用工具时的提醒** → 优先写 `TOOLS.md`
- 这是 Bot **只在某个领域、某类任务里才需要的知识** → 更可能是 Skill

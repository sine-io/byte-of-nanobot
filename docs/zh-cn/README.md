...
!!! info "先确认你正在阅读哪个版本"
    ...
    正文命令和配置以 **nanobot v0.2.2** 为可操作基线，对应上游固定提交 [`e2e75c9`](https://github.com/HKUDS/nanobot/tree/e2e75c913f3524d4bc5b23487a4eed5329eef182)。最新主线只对照本轮审计提交 [`main@b189a376`](https://github.com/HKUDS/nanobot/tree/b189a37648e4fa64f662b15de4f78ffd0bab403b)。

    教程若需要介绍 main 独有行为，会使用“main 差异（不适用于 v0.2.2）”提示框单独说明。提示框中的内容用于理解未来变化，不属于稳定版操作步骤。

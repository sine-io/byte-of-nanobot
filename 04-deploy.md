...
| `/stop` | 停止当前正在执行的任务 |
| `/restart` | 重启 Bot 进程 |
| `/status` | 查看版本、模型、上下文、任务等状态 |
| `/history [n]` | 查看当前会话最近 N 条消息 |
| `/dream` | 立即触发 Dream 记忆整理 |
| `/dream-log` | 查看最近一次 Dream 记忆变更 |
| `/dream-restore` | 列出或恢复 Dream 记忆历史版本 |
